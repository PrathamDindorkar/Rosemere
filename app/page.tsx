      ...
      <section id="clients" className="py-32 bg-slate-950">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {clients.map((client, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className="h-40 flex flex-col items-center justify-center px-8 py-10 bg-white/5 rounded-2xl border border-white/5 
              ...
              >
                <img
                  ...
                  className="max-h-20 w-auto object-contain transition-transform duration-500 
                ...
                <span className="mt-4 text-sm font-bold text-transparent group-hover:text-slate-900 
                           transition-colors duration-300 uppercase tracking-widest text-center">
                  {client.name}
                </span>
              </motion.div>
            ))}
          ...
          <p className="text-xs text-slate-600 mt-8 text-center">
            Logos provided by <a href="https://logo.dev" className="hover:text-cyan-400 transition-colors">logo.dev</a>
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="bg-gradient-to-br from-cyan-600 to-blue-700 rounded-[3rem] p-12 md:p-20 text-center text-white shadow-2xl relative overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row gap-6 justify-center items-center relative z-10">
              <a
                href="mailto:pras@rosemere-ltd.co.uk?subject=Inquiry%20from%20Rosemere%20Website&body=Hello,%20I%20would%20like%20to%20discuss..."
                className="flex items-center gap-3 bg-slate-950 px-8 py-4 rounded-full font-bold hover:scale-105 transition-transform shadow-xl"
              >
                <Mail size={18} className="text-cyan-400" />
                pras@rosemere-ltd.co.uk
              </a>
